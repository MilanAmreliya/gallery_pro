...
class VerifyPassword extends StatefulWidget {
  final String oldPaas;

  const VerifyPassword({Key? key, required this.oldPaas}) : super(key: key);
  @override
...
class _VerifyPasswordState extends State<VerifyPassword> {
  ...
  _onPasscodeEntered(String enteredPasscode) {
    ...
    if (widget.oldPaas == enteredPasscode) {
      PreferenceManager.setPassword(value: enteredPasscode);
